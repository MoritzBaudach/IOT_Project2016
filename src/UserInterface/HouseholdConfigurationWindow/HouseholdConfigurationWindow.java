package UserInterface.HouseholdConfigurationWindow;
...
public class HouseholdConfigurationWindow {

    //all member attributes
    //textfields
    TextField mHouseholdNameTF;
    TextField mHouseholdIdTF;

    //buttons
    Button mSaveHouseholdButton;
    Button mDeleteHouseholdButton;
    Button mSelectHouseholdButton;
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("HouseholdConfigurationWindow.fxml"));
        ...
        this.mHouseholdNameTF = (TextField) scene.lookup("#connection_alias_name_textfield");
        this.mHouseholdIdTF = (TextField) scene.lookup("#connection_sever_port_textfield");
        ...
        this.mSaveHouseholdButton = (Button) scene.lookup("#save_connection_profile_button");
        this.mDeleteHouseholdButton= (Button) scene.lookup("#delete_connection_profile_button");
        this.mSelectHouseholdButton= (Button)scene.lookup("#select_connection_profile_button");
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                //check if new selected value isn´t the same than it was before
                    ...
                    if (searchedProfile == null) {
                        ...
                        mHouseholdNameTF.setText(searchedProfile.getmConnectionProfileAliasName());
                        DeviceCategoryTF.setText(searchedProfile.getmAdress());
                        mHouseholdIdTF.setText(searchedProfile.getmPort());
...
*/
        ...
        this.mSaveHouseholdButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    ...
                    String connectionAlias = mHouseholdNameTF.getText();
                    String serverPort = mHouseholdIdTF.getText();
        ...
        this.mSelectHouseholdButton.setOnAction(new EventHandler<ActionEvent>(){
            public void handle(ActionEvent event) {
        ...
        this.mDeleteHouseholdButton.setOnAction(new EventHandler<ActionEvent>(){
            public void handle(ActionEvent event) {
                String searchTerm = (String) mExistingDevicesLV.getSelectionModel().getSelectedItem();
